            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <a class='btn btn-primary' href='add_menu.php' ><i class='fa fa-plus'></i> Tambah Data Menu</a>
                </div>
                      ...
                      <tr>
                        <td>
						 ...
						 <?php echo $d['NAMA_MENU']; ?>
						  ...
						  <td> 
						 <?php echo rupiah($d['HARGA_MENU']); ?>
						</td>
                        <td class="td-actions">
						 <a class='btn btn-success' href="edit_menu.php?ID_MENU=<?php echo $d["ID_MENU"];?>" 
							><i class='fa fa-edit'></i></a>
							<a class='btn btn-danger' onclick="return confirm('Anda yakin ingin menghapus data tersebut?');" 
							href="aksi_menu.php?act=delete&ID_MENU=<?php echo $d["ID_MENU"];?>" 
